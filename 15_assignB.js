...
arrayEmployee.forEach(employee => {if(employee.empSalary >= 75000) {console.log(employee.empName ,employee.empCompany, employee.empSalary);}});

console.log("Employees working in finance department only");
arrayEmployee.forEach(employee => {if(employee.empDept >= "75000") {console.log(employee.empName ,employee.empCompany, employee.empDept);}});
